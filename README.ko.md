...
예시 영역은 예약되어 있습니다. 검증 가능한 원작 링크나 089 원본 프롬프트와 직접 대조한 확장 예시가 준비되면 이곳에 먼저 표시하며, 다른 번호의 이미지나 깨진 자리표시자로 대신하지 않습니다.
...
**Panel 089**은 가장 기억할 주제를 하나의 주인공 소품 삽화로 두고, 동작·식물·사물·음식·옷·건축·재료·우연한 세부를 몇 개의 보조 조각으로 종이 위에 띄웁니다. 가는 느슨한 선, 수채화, 색연필, 소량의 파스텔이 종이와 손의 흔적을 남깁니다.
...
| **대표 특징** | 떠 있는 소품 삽화, 가는 느슨한 선, 수채화, 색연필, 따뜻한 흰 종이, 손글씨 메모 |
| **입력 존중 방식** | 주제의 정체성과 서사를 보존하고 장면 전체가 아닌 기억할 세부만 추출함 |
