...
```text
/xxd-panel-089 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，089 设计在下）
2. 左右对照（原图在左，089 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-089/<fresh-task>/
...
- `references/xxd-panel-089-prompt.zh-CN.md`
- `references/xxd-panel-089-prompt.en.md`
