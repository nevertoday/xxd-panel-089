<p align="center"><img src="./assets/banner.svg" alt="XXD Panel 089 project banner" width="1200"></p>
...
Sample positions are reserved. Verifiable original works or extensions reviewed directly against the Panel 089 source brief will be shown here first; images from another numbered Panel and broken placeholders are never substituted.
...
```text
analyse subject, contour, pose, and narrative relation → choose one protagonist spot → extract a few actions, plants, objects, food, clothing, architecture, materials, or accidental details → arrange floating spots through varied scale, height, density, and direction → draw with loose fine line, watercolour, coloured pencil, and a little pastel → weave handwritten notes through generous warm-white paper
```

## Recognisable finished traits

- The protagonist has the greatest visual weight; supporting fragments form a loose response rather than an even grid or sticker catalogue.
- Fine lines retain hesitation, wobble, breaks, visible paper, pencil grain, translucent watercolour, and occasional pastel friction.
- Select the source's brightest, liveliest relationships and soften them into clear blues, aqua, fresh green, cream yellow, apricot, coral, or gentle violet.
- Sparse hand-lettered annotations arise from action, mood, sound, smell, memory, or accidental detail and may sit between spots or follow an object's contour.
- Avoid complete-scene redraws, complex backgrounds, rigid grids, sticker UI, heavy black outlines, childish cartoons, precise vectors, 3D, and commercial templates.

All aesthetic constraints live only in the [canonical prompt](references/original-prompt/zh-CN.md). The Skill and runtime adapters resolve delivery variables. [Skill workflow](SKILL.md) · [English runtime adapter](references/xxd-panel-089-prompt.en.md)
...
| **[xxd-panel-089](https://github.com/nevertoday/xxd-panel-089)** | PRIVATE LIFESTYLE JOURNAL · FLOATING SPOTS · LOOSE LINE · WATERCOLOUR · COLOURED PENCIL · EDITORIAL WHITESPACE |
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–089) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
