<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 089" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 089｜دفتر مشاهد الحياة الصغيرة

### يحرّر الصورة كصفحة يوميات شخصية هادئة وناضجة
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 089 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تفقد إعادة رسم المشهد الكامل خفة شظايا الحياة، بينما تحوّل الشبكة المنتظمة الصفحة إلى كتالوج ملصقات.

يجعل **Panel 089** موضوعاً واحداً واضحاً يحمل السرد، ثم يوزع حوله عدداً قليلاً من الحركات والنباتات والأشياء والطعام والملابس والعمارة والخامات والتفاصيل العارضة كرسوم صغيرة عائمة. وتحافظ الخطوط الرقيقة المرتخية والألوان المائية والأقلام الملونة وقليل من الباستيل على بياض الورق وأثر اليد.
...
> استخدم XXD Panel 089 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** يوميات حياة شخصية · رسوم صغيرة عائمة · خط يدوي مرتخٍ · ألوان مائية وأقلام ملونة · ألوان مشرقة ناعمة · فراغ تحريري
...
|---|---|
| **الناتج** | صفحة يوميات شخصية فيها بطل وشظايا حياة ومساحة تتنفس |
| **البصمة الواضحة** | رسوم صغيرة عائمة، خط رقيق مرتخٍ، ألوان مائية، أقلام ملونة، ورق دافئ، ألوان مشرقة ناعمة وملاحظات يدوية |
| **احترام المصدر** | يحفظ هوية الموضوع وسرده ويستخرج التفاصيل اليومية التي تستحق التذكر دون إعادة رسم المشهد كله |
...
```text
تحليل الموضوع والمحيط والوضعيّة والعلاقات السردية → اختيار وحدة موضوع واحدة تحمل السرد المحوري → استخراج عدد قليل من الحركات والسمات الجزئية والنباتات والأدوات والطعام والملابس والعمارة والخامات → توزيع الرسوم عائماً مع تنويع الحجم والارتفاع والكثافة والاتجاه → الرسم بخطوط رفيعة وألوان مائية وأقلام ملوّنة وقليل من الباستيل → نسج الملاحظات اليدوية بين الرسوم مع إبقاء فراغ أبيض دافئ وواسع
```

## سمات النتيجة النهائية

- يحظى الموضوع بأكبر وزن بصري، بينما تتجاوب الشظايا الأخرى معه بصورة رخوة؛ فلا توزيع متساوياً ولا شبكة منتظمة ولا كتالوجاً لمنتجات الملصقات.
- تحتفظ الخطوط الرفيعة بالتردد والارتعاش والانقطاع، وتُظهر أرضية الورق وحبيبات القلم الرصاص وطبقات الألوان المائية الرقيقة وأثر الباستيل الموضعي.
- تُختار من الأصل أكثر الألوان إشراقاً وحيوية، ثم تُلطّف إلى أزرق صافٍ وأزرق مخضرّ وأخضر غضّ وأصفر كريمي ومشمشي ومرجاني وبنفسجي ناعم.
- تنشأ ملاحظات hand-lettered annotation القليلة من الحركة أو المزاج أو الصوت أو الرائحة أو الذكرى أو التفصيل العارض، ويمكن وضعها بين الرسوم أو بمحاذاة محيط الأشياء.
- تجنّب إعادة رسم المشهد كاملاً، والخلفيات المعقدة، والشبكات المنتظمة، وواجهة الملصقات UI، والخطوط السوداء السميكة، ورسوم الأطفال الكرتونية، والرسوم المتجهية الدقيقة، والتصيير ثلاثي الأبعاد 3D، والقوالب التجارية.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-089-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 089. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-089 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-089 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-089 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-089 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-089 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 089 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-089 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-089`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-089-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-089-prompt.zh-CN.md)
...
| **[xxd-panel-089](https://github.com/nevertoday/xxd-panel-089)** | يوميات شخصية · رسوم صغيرة عائمة · خط مرتخٍ · ألوان مائية · أقلام ملونة · فراغ تحريري |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–089) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
